...
class ShopTest {
    ...
    void testAddProduct() {
        Shop shop = new Shop();
        Food apple = new Food("Apple", LocalDate.of(2023, 10, 1), LocalDate.of(2023, 12, 31), 50, 0);
    ...
    void testGetProducts() {
        Shop shop = new Shop();
        Food apple = new Food("Apple", LocalDate.of(2023, 10, 1), LocalDate.of(2023, 12, 31), 50, 0);
        Food banana = new Food("Banana", LocalDate.of(2023, 9, 5), LocalDate.of(2023, 11, 30), 40, 0);
